...
class BMICalculator(App):
    ...
    def calculate_bmi(self, instance):
        try:
            ...
            recommendations = {
                'Underweight': 'You should consider gaining some weight. Consult a nutritionist for\na proper diet plan.',
                'Normal Weight': 'Congratulations! You are in a healthy weight range.',
                'Overweight': 'You should consider losing some weight through a combination of\ndiet and exercise. Consult a healthcare professional.',
                'Obesity': 'Immediate weight loss is recommended. Consult a healthcare\nprofessional for a personalized weight loss plan.'
            }
